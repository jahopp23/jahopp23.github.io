...
# Generated by GNU Autoconf 2.69 for gifsicle 1.88.
#
#
...
if test "$ac_init_help" = "long"; then
  ...
  cat <<_ACEOF
\`configure' configures gifsicle 1.88 to adapt to many kinds of systems.
...
if test -n "$ac_init_help"; then
  case $ac_init_help in
     short | recursive ) echo "Configuration of gifsicle 1.88:";;
   esac
  cat <<\_ACEOF
